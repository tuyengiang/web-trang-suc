        ...
        <div class="row">
            ...
            <div class="col-md-2">
                    ...
                    <div class="login-list">
                        <ul>
                            <?php if (isset($_SESSION['email']) && isset($_SESSION['status'])) { ?>
                                ...
                                <?php } else { ?>
                                    <li><a href="<?php echo curPageURL().'cart/order-product.php'; ?>"><i
                                                    class="fa fa-sort"></i> Đơn hàng của bạn</a></li>
                                    <li><a href="<?php echo curPageURL(); ?>admin/logout.php"><i
                                                    class="fa fa-sign-out"></i> Đăng xuất</a></li>
                                <?php } ?>
                            <?php } else { ?>
                ...
                <div class="header-cart">
                    <a href="<?php echo curPageURL(); ?>cart/"><i class="fa fa-shopping-cart"></i>
                        <?php if (isset($_SESSION['cart'])) {
                            ...
                            endforeach;
                            ?>
                            <div class="cart-item"><?php echo $count; ?></div>
                            <?php
                        } else { ?>
